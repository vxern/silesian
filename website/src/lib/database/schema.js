...
export { categories, categoriesRelations } from "./tables/categories";
export { entriesToCategories, entriesToCategoriesRelations } from "./tables/entries-to-categories";
export { entries, entriesRelations } from "./tables/entries";
export { locations, locationsRelations } from "./tables/locations";
...
export { sources, sourcesRelations } from "./tables/sources";
